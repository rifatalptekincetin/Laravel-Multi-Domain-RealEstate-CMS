<div class="listing-item">
    <article class="geodir-category-listing fl-wrap">
        <div class="geodir-category-img fl-wrap">
            <a href="{{$_listing->url(get_subdomain())}}" class="geodir-category-img_item">
            ...
            <ul class="list-single-opt_header_cat">
                @foreach($_listing->categories()->orderBy('parent_id','asc')->get() as $key=>$category)
                    <li @if(!$key) style="display:none;" @endif><a href="{{$category->url(get_subdomain())}}" class="cat-opt blue-bg">{{$category->title}}</a></li>
                @endforeach
            </ul>
        ...
        <div class="geodir-category-content fl-wrap">
            <h3 class="title-sin_item"><a href="{{$_listing->url(get_subdomain())}}">{{ $_listing->title }}</a></h3>
            ...
            <div class="geodir-category-footer fl-wrap">
                <a href="{{ $_listing->user->url(get_subdomain()) }}" class="gcf-company">
