<div class="listing-item">
    <article class="geodir-category-listing fl-wrap">
        <div class="geodir-category-img fl-wrap  agent_card">
            <a href="{{ $_agent->url(get_subdomain()) }}" class="geodir-category-img_item">
        ...
        <div class="geodir-category-content fl-wrap">
            ...
            <div class="agent_card-title fl-wrap">
                <h4><a href="{{ $_agent->url(get_subdomain()) }}" >{{ $_agent->name }}</a></h4>
                <h5><a href="{{ $_agent->url(get_subdomain()) }}">{{ $_agent->title }}</a></h5>
            </div>
            <p>
                {!! mb_strtolower( mb_substr( strip_tags($_agent->about), 0, 90) ) !!}
            </p>
            <div class="geodir-category-footer fl-wrap">
                <a href="{{ $_agent->url(get_subdomain()) }}" class="btn float-btn color-bg small-btn">Profili Gör</a>
