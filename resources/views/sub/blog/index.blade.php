...
<div id="wrapper">
    <div class="content">
        @include('sub.partials.title',["title"=>settings('blogs_title'),"description"=>settings('blogs_description'),'image'=>get_image_url(settings("blogs_image"))])
        @php
            $links=[
                ["title"=>"Anasayfa","url"=>route("sub.home",get_subdomain())],
            ];
        @endphp
        @include('sub.partials.breadcrumbs',['links'=>$links,'title'=>settings('blogs_title')])
