...
<div id="wrapper">
    <div class="content">
        @include('sub.partials.title',["title"=>$tag->title,"description"=>$tag->content,'image'=>get_image_url(settings("blogs_image"))])
        @php
            $links=[
        ...
        @endphp
        @include('sub.partials.breadcrumbs',['links'=>$links,'title'=>$tag->title])
