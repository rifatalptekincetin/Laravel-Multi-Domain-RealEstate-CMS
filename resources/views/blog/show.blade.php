...
<div id="wrapper">
    <div class="content">
        @include('partials.title',["title"=>$blog->title,"description"=>Null,'image'=>$blog->image->url])
        @php
            $links=[
        ...
        @endphp
        @include('partials.breadcrumbs',['links'=>$links,'title'=>$blog->title])
                    ...
                    <article class="post-article fl-wrap">
                                 ...
                                 <div class="post-opt">
                                    <ul class="no-list-style">
                                       ...
                                       <li><i class="fal fa-user"></i>
                                          @if($blog->user)
                                             <a href="{{ $blog->user->url() }}">{{ $blog->user->name }}</a>
                                          @endif
                                       </li>
                                    </ul>
                                 </div>
                     ...
                     <div class="content-nav_holder fl-wrap color-bg">
                        <div class="content-nav">
                           ...
                           @if($blog->previous())
                                 <li>
                                    <a href="{{ $blog->previous()->url() }}" class="ln"><i class="fal fa-long-arrow-left"></i><span> <strong>{{$blog->previous()->title}}</strong></span></a>
                            ...
                            @if($blog->next())
                                 <li>
                                    <a href="{{$blog->next()->url()}}" class="rn"><span ><strong>{{$blog->next()->title}}</strong></span> <i class="fal fa-long-arrow-right"></i></a>
                                    <div class="content-nav-media">
