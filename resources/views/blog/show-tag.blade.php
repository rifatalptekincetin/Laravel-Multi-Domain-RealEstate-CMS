...
<div id="wrapper">
    <div class="content">
        @include('partials.title',["title"=>$tag->title,"description"=>$tag->content,'image'=>get_image_url(settings("blogs_image"))])
        @php
            $links=[
        ...
        @endphp
        @include('partials.breadcrumbs',['links'=>$links,'title'=>$tag->title])
