<div class="listing-item">
    <article class="geodir-category-listing fl-wrap">
        <div class="geodir-category-img fl-wrap">
            <a href="{{ $_agency->url() }}" class="geodir-category-img_item">
        ...
        <div class="geodir-category-content fl-wrap">
            ...
            <div class="agent_card-title fl-wrap">
                <h4><a href="{{ $_agency->url() }}" >{{ $_agency->title }}</a></h4>
                <div class="geodir-category-location fl-wrap">
                    <a href="{{ $_agency->url() }}"><i class="fas fa-map-marker-alt"></i>  {{ $_agency->address ?? $_agency->state->title, $_agency->city->title, $_agency->district->title }}</a> 
            ...
            <div class="small-facts fl-wrap">
                <ul>
                    ...
                    <li><i class="fal fa-comment-alt"></i> <span><strong>{{ $_agency->reviews()->count() }}</strong>Yorum</span></li>
                </ul>
            </div>
            <div class="geodir-category-footer fl-wrap">
                <a href="{{ $_agency->url() }}" class="btn float-btn color-bg small-btn">Siteye Git</a>
