...
class ReviewResource extends Resource
{
            ...
            ->schema([
                ...
                Forms\Components\Select::make('reviewable_id')
                    ...
                    ->options(function(callable $get){
                        return $get('reviewable_type')::where('id',auth()->user()->id)->limit(50)->pluck('name', 'id');
                    })
                    ->getSearchResultsUsing(function (string $search,callable $get): array {
                        return $get('reviewable_type')::where('name','like',"%".$search."%")->where('id',auth()->user()->id)->limit(50)->pluck('name', 'id')->toArray();
                    }),
            ])->columns(2);
    }
    ...
    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()
            ->where('reviewable_id', auth()->user()->id);
    }
}
